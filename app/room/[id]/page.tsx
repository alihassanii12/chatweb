      ...
      <header className="hidden lg:flex px-4 py-2 border-b border-white/5 items-center justify-between gap-3 z-10 shrink-0 bg-[#0a0a0c]">
        <div className="flex items-center gap-2 min-w-0 text-xs">
          ...
          <span className="text-gray-600 truncate">
            {partnerUsername ? `· ${partnerUsername}` : '· waiting'}
          </span>
        </div>
        ...
        <div className="flex gap-1 shrink-0">
          <button
            ...
            className={`px-2 py-1 rounded text-[11px] font-medium flex items-center gap-1 ${
              layoutMode === 'both' ? 'bg-purple-600 text-white' : 'text-gray-500 bg-white/5'
            }`}
          >
          ...
          <button
            ...
            className={`px-2 py-1 rounded text-[11px] font-medium flex items-center gap-1 ${
              layoutMode === 'chat_only' ? 'bg-purple-600 text-white' : 'text-gray-500 bg-white/5'
            }`}
          >
